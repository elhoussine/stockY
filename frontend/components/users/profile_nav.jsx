  ...
  render() {
    return (
      <ul id="profile-nav-bar">
        ...
        <Link to="/profile/listings"><li onClick={this.changeBold} id="p-navbar-listings" className="profile-nav-item"><span className="nav-icon">💵</span><span className="nav-label">Products</span></li></Link>
